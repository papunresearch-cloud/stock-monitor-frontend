...
function App() {
  ...
  // Read Firebase /system_status node for Health Modal
  useEffect(() => {
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      setTimeout(() => setIsSyncLocked(false), 900000); // 15-minute cooldown
    }
  };
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', width: '100%', boxSizing: 'border-box' }}>
      ...
      {/* 6. LOWER PART: STOCK WATCHLIST GRID */}
