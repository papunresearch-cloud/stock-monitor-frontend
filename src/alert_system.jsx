...
export default function AlertSystemModal({ isOpen, onClose }) {
  ...
  useEffect(() => {
    ...
    const loadAlertConfiguration = async () => {
      setLoading(true);
      try {
        // 1. Fetch current watchlist stocks directly from /watchlist/watchlist
        ...
        // 2. Fetch /alerts configuration node
        ...
        // Per-stock controls (default to true/enabled)
  ...
  // --------------------------------------------------------------------------
  // Checks if mobile number is a pure 10-digit Indian phone number
  const cleanAndValidateIndianMobile = (rawInput) => {
    ...
    // If starts with +91 or 91 with total 12 digits, extract the 10 digits
    ...
    >
      ...
      >
        ...
        <div style={{ overflowY: "auto", padding: "18px 20px", display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          {/* SECTION 4: WHATSAPP RECIPIENTS (10-DIGIT CHECK) */}
      ...
      {/* ========================================================================= */}
      {/* 3-QUESTION VERIFICATION PRE-COMMIT AUDIT MODAL (N - Y - N)               */}
      {/* ========================================================================= */}
      {showConfirmModal && (
        <div
          style={{
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px", borderTop: "1px solid #334155", paddingTop: "14px" }}>
              ...
              {/* Exact Condition: Question 1 = N, Question 2 = Y, Question 3 = N */}
