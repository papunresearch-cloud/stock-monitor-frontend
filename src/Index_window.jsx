  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '5px', color: '#e2e8f0' }}>
          <span style={{ width: '9px', height: '9px', borderRadius: '2px', background: 'linear-gradient(180deg, #02A86B, #016641)', border: '1px solid #7c2d12', display: 'inline-block' }}></span>
          25DR
        </div>
      </div>
            ...
            <div style={{ 
              ...
              {span25 && (
                <div style={{
                  ...
                  left: span25.left,
                  width: span25.width,
                  background: 'linear-gradient(180deg, #02A86B 0%, #016641 100%)',
